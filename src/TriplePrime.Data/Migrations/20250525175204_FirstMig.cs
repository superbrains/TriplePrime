        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredDeliveryTime = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PreferredDeliveryDay = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AllowContactlessDelivery = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationPreferencesId = table.Column<int>(type: "int", nullable: false),
                    DeliveryPreferencesId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.DeliveryPreferencesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodPacks_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SocialMediaHandle = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deliveries_DeliveryAddresses_DeliveryAddressId",
                        column: x => x.DeliveryAddressId,
                        principalTable: "DeliveryAddresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deliveries_FoodPacks_FoodPackId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodPackItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FoodPackItems_FoodPacks_FoodPackId",
                        column: x => x.FoodPackId,
                        principalTable: "FoodPacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavingsPlans_FoodPacks_FoodPackId",
                        column: x => x.FoodPackId,
                        principalTable: "FoodPacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MarketerId1 = table.Column<int>(type: "int", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Referrals_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodPackId = table.Column<int>(type: "int", nullable: true),
                    ...
                    SavingsPlanId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_FoodPacks_FoodPackId",
                        column: x => x.FoodPackId,
                        principalTable: "FoodPacks",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferralId1 = table.Column<int>(type: "int", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Commissions_Marketers_MarketerId",
                        column: x => x.MarketerId,
                        principalTable: "Marketers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_DeliveryPreferencesId",
                table: "AspNetUsers",
                column: "DeliveryPreferencesId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_NotificationPreferencesId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Commissions_MarketerId",
                table: "Commissions",
                column: "MarketerId");

            migrationBuilder.CreateIndex(
                name: "IX_Commissions_ReferralId",
                table: "Commissions",
                column: "ReferralId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodPackItems_FoodPackId",
                table: "FoodPackItems",
                column: "FoodPackId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodPacks_ApplicationUserId",
                table: "FoodPacks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Referrals_ApplicationUserId",
                table: "Referrals",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Referrals_MarketerId",
                table: "Referrals",
                column: "MarketerId");
